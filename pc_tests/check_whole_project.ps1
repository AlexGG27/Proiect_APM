...
Check-Pattern $stmMain 'htim->Instance != TIM2' 'stm32_tim2_callback_filters_timer'
...
Check-Pattern $stmMain 'switch \(g_armState\)' 'stm32_state_machine_in_isr'
Check-Pattern $stmMain 'ARM_WriteOutputBus\(ARM_ReadCommand\(\)\)' 'stm32_transmit_in_isr'
Check-Pattern $stmMain '__WFI\(\)' 'stm32_main_waits_for_interrupt'
